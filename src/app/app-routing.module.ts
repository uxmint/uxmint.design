...
const routes: Routes = [
  ...
  { path: 'projects/car-usability', component: CarUsabilityTestingComponent },
  { path: 'services/ux-consulting', component: UxConsultingComponent },
  { path: 'services/interface-design', component: VisualDesignComponent },
  { path: 'services/front-end-dev', component: DevelopmentComponent },
  { path: 'services/back-end-dev', component: BackEndDevelopmentComponent },
